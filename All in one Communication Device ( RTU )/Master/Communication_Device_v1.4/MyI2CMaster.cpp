...
MyI2CMaster::MyI2CMaster() {
}

void MyI2CMaster::i2cBegin() {
...
void MyI2CMaster::requestDataFromSlave() {
...
// -----------------------------------------------------------------------------
void MyI2CMaster::sendDataToSlave(byte address, String data) {
  Wire.beginTransmission(address);

...
String deviceID = devNamePrefix + "862733079316660";              // DEVICE ID
...
String mqttAlertPublishTopic = "RTUAlert862733079316660/status";  // MQTT ALERT PUBLISH TOPIC
...
bool isCheckingStatus = false;  // Are we currently waiting for a status check?
bool statusTcpFound = false;    // Did we find the TCP URL in the response?
bool lteBeginFailed = true;
bool lteNetworkStable = false;
